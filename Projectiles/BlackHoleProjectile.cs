...
namespace InitiateMod.Projectiles     //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class BlackHoleProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            projectile.height = 160;       //Set the hitbox height
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Vortex);  //this is the dust that this projectile will spawn
