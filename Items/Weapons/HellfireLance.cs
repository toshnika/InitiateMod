...
{
    public class HellfireLance : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Flame Vortex");
            Tooltip.SetDefault("Fire Tornadoes...");
        }

        public override void SetDefaults()
        {
                //the name displayed when hovering over the Weapon ingame.
            item.damage = 48;    //The damage stat for the Weapon.
            ...
            item.shoot = mod.ProjectileType("HellfireLanceProjectile");  //This defines what type of projectile this weapon will shoot   
